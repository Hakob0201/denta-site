...
/***/ "./node_modules/moment/locale sync recursive hy-am":
/*!***********************************************!*\
  !*** ./node_modules/moment/locale sync hy-am ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
webpackContext.id = "./node_modules/moment/locale sync recursive hy-am";
    ...
    function loadLocale(name) {
        ...
        if (
            ...
            try {
                ...
                __webpack_require__("./node_modules/moment/locale sync recursive hy-am")("./" + name);
...
var datepicker = __webpack_require__(/*! air-datepicker */ "./node_modules/air-datepicker/src/js/air-datepicker.js");

__webpack_require__(/*! ./plugin/datepicker/datepicker.hy */ "./resources/js/plugin/datepicker/datepicker.hy.js");

__webpack_require__(/*! ./plugin/datepicker/datepicker.en */ "./resources/js/plugin/datepicker/datepicker.en.js");
...
$('.search-input').on('keyup', function (e) {
  var searchData = JSON.parse(JSON.parse(localStorage.getItem('catntag')).data);
  ...
  timer = setTimeout(function () {
    if (toSearch.length >= 3) {
      if (canSend === true) {
        canSend = false;
        $.get('/' + $('html').attr('lang') + '/search?q=' + toSearch, function () {}).done(function (data) {
  ...
  if (toSearch !== '') {
    ...
    for (var type in searchData) {
      for (var i = 0; i < searchData[type].length; i++) {
        for (var key in searchData[type][i]) {
...
function mobileOpen(open, block, icon) {
  var overflow = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
...
function relativeDates() {
  ...
  $('.relative-date').each(function (i, e) {
    if (locale == 'hy') locale = 'hy-am';
    moment.locale(locale); // moment.locale('hy-am');
...
$('.datepicker-i').datepicker({
  ...
  onSelect: function onSelect(fd, d, picker) {
    var cat = picker.$el.data('category') + '/';
  ...
  onShow: function onShow(picker, animationCompleted) {
...
function infLoad(pag) {
  ...
  $.get(loc).done(function (data) {
    ...
    if (pag.attr('data-page').includes('q')) {
      var after = pag.attr('data-page').split('=')[1];
...
/***/ "./resources/js/plugin/datepicker/datepicker.en.js":
/*!*********************************************************!*\
  !*** ./resources/js/plugin/datepicker/datepicker.en.js ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./resources/js/plugin/datepicker/datepicker.hy.js":
/*!*********************************************************!*\
  !*** ./resources/js/plugin/datepicker/datepicker.hy.js ***!
  \*********************************************************/
/*! no static exports found */
...
__webpack_require__(/*! /var/www/ejc.am/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /var/www/ejc.am/resources/sass/app.scss */"./resources/sass/app.scss");
